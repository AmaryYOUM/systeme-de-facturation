...
let inactivityTime = function () {
    ...
    // Fonction pour rï¿½initialiser le minuteur
    const resetTimer = function () {
        clearTimeout(timeout); // Effacer le minuteur prï¿½cï¿½dent
        timeout = setTimeout(logoutUser, 300000); // Dï¿½finir un nouveau minuteur de 5 minute
    };

    // Fonction pour dï¿½connecter l'utilisateur
    const logoutUser = function () {
        // Effectuer une requï¿½te AJAX pour dï¿½connecter l'utilisateur
        ...
        xhr.send(); // Envoyer la requï¿½te
    };

    // ï¿½couter les ï¿½vï¿½nements pour rï¿½initialiser le minuteur
    window.onload = resetTimer; // Au chargement de la page
    window.onmousemove = resetTimer; // Lorsque la souris se dï¿½place
