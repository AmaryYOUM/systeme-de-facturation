...
<body>
    ...
    <div class="logo-details"  style="height: 140px; width: 140px; margin-top: 10px; margin-left: 30px; background-color: white;  border-radius: 100%;">
      <a href="<?php echo Router::url('chef_service/services/view/'.$this->Session->user('service_id')) ?>">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="<?php echo Router::url('chef_service/prestations/edit') ?>">
            <i class="bx bx-box"></i>
...
let inactivityTime = function () {
    ...
    const resetTimer = function () {
        ...
        timeout = setTimeout(logoutUser, 300000); // Définir un nouveau minuteur de 5 minutes
    };
