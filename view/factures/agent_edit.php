<div class="bloc-content">
    ...
    <div class="cote-a-cote" style="width: 99%;">
        <div class="table-boxes">
            ...
            <form action="<?php echo Router::url('agent/factures/edit/'.$id); ?>" method="post">
                <div class="input-box">
                    <?php echo $this->Form->input('id','hidden'); ?>
                </div> 
                <br>
                    ...
                    <div class="cote-a-cote" style="width: 100%;">
                        ...
                        <div class="cote-a-cote" style="width: 100%">
                            <div>
                                ...
                                <h6 style="padding: 10px"> Total Montant : <?php echo number_format($sum_fact,0,',',' '); ?> <span>Fcfa</span></h6>
                            </div>
                            <div>
                                        ...
                                        <td>
                                            ...
                                            <?php foreach($prescripteurs as $k => $w): ?>
                                                <?php if ($v->prescripteur_id == $w->id): ?>
                                                    <td><a href="<?php echo Router::url("agent/prescripteurs/detail/{$w->id}"); ?>"><?php echo "$w->prenom_prescripteur $w->nom_prescripteur"; ?></a></td>
                                                <?php endif ?>
                                            <?php endforeach ?>
                                            ...
                                            <td>
                                            <a href="<?php echo Router::url("agent/factures/detail/{$v->num}"); ?>">Imprimer &rarr;</a><span> | </span>
                                            <a  onclick="return confirm('Voulez vous vraiment signaler à l\'administrateur de supprimer cet facture');" href="<?php echo Router::url('agent/factures/modif/'.$v->id); ?>">A sup</a>
                                            </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
