            ...
            <tbody id="tbody">
                <?php foreach($patients as $k => $v): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo Router::url('admin/patients/edit/'.$v->id); ?>">Editer</a><span> | </span>
                            <a  onclick="return confirm('Voulez vous vraiment supprimer cet agent');" href="<?php echo Router::url('admin/patients/delete/'.$v->id); ?>">Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
